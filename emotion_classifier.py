...
def naive_bayes(training1_sentence, training2_sentence, testing_sentence, alpha, prob1, prob2):
    ...
    classify1 = math.log(prob1) + calculate_doc_prob(training_model1, testing_model, alpha)
    classify2 = math.log(prob2) + calculate_doc_prob(training_model2, testing_model, alpha)
