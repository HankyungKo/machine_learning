...
def plot_champions(champs_df, champ_pca_array, champ_classes):
    ...
    champ_color = scaler.fit_transform(np.array(champ_classes).astype('float64'))

    plt.figure(figsize=(20, 10))

    plt.scatter(x, y,  c = champ_color, s = magic*1500, cmap = plt.get_cmap('Spectral'))
